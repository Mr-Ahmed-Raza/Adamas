...
const { addProducts, showAllProducts, deleteProducts, updateProducts,singleProduct,getFeaturedProducts,latestProducts,recentProducts,getRecommendedProducts } = require("../controllers/productController")
